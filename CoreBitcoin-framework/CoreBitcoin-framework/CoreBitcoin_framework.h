//
//  CoreBitcoin_framework.h
//  CoreBitcoin-framework
//
//  Created by 王欣 on 2020/6/21.
//  Copyright © 2020 王欣. All rights reserved.
//

#import <Foundation/Foundation.h>

//! Project version number for CoreBitcoin_framework.
FOUNDATION_EXPORT double CoreBitcoin_frameworkVersionNumber;

//! Project version string for CoreBitcoin_framework.
FOUNDATION_EXPORT const unsigned char CoreBitcoin_frameworkVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <CoreBitcoin_framework/PublicHeader.h>
